...
export default function OutbreakScreen() {
  ...
  const { alerts, acknowledgeAlert } = useOutbreak();
            ...
            <View style={styles.alertHeader}>
              ...
              <View style={styles.alertInfo}>
                <Text style={styles.alertTitle}>
                  {alert.caseCount} cases in cluster
                </Text>
...
const styles = StyleSheet.create({
  ...
  alertTime: { fontSize: 12, color: "#4B5563", marginTop: 2 },
  ackBadge: {
  ...
  ackText: { fontSize: 12, color: "#4B5563", fontWeight: "700" },
